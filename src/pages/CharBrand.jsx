        ...
        >
          <div className="grid md:grid-cols-2 gap-8 p-10 text-white">
            ...
            <div className="space-y-4 ">
              <h1 className="text-3xl font-semibold">Brand Management Course</h1>
              ...
              <p className="text-lg">
                Hey I am Charlotte. I am a Brand Management professional 
            ...
            <div className="flex justify-center">
              <img src={Brand} alt="" className="w-72 mb-20 ml-50 -mt-10" />
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 p-4">
          ...
          <div className="lg:col-span-2 space-y-4 ">
            ...
            <p className="text-gray-600 font-medium text-justify pl-10">
              The Brand Management program offers a strategic approach to building and maintaining strong brands. You will learn brand positioning, identity development, consumer behavior analysis, and brand communication across digital and traditional channels. The program includes real-world case studies and strategic planning exercises. By the end of the course, you will be able to develop brand strategies, manage brand consistency, and contribute effectively to marketing and branding teams.
            </p>
              ...
              <details open className="group border-b ">
                ...
                <div className="px-6 pb-4 space-y-3">
                  {[
                    ...
                    "Overview of Brand Management Process",
                  ].map((item, i) => (
          ...
          <div className="bg-white shadow-lg relative -mt-25 rounded-xl p-4 h-fit">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-3">
                <button onClick={() => (isWish('charbrand') ? removeFromWishlist('charbrand') : addToWishlist({ id: 'charbrand', title: 'Brand Management', price: 0 }))}>
                  <FaHeart className={`${isWish('charbrand') ? 'text-red-500' : 'text-gray-400'} text-lg`} />
                </button>
<RiShareForwardLine
            ...
            <div className="mt-4">
              <button onClick={() => addToCart({ id: 'charbrand', title: 'Brand Management', price: 0 })} className="flex items-center gap-2 bg-[#003372] text-white px-4 py-2 rounded-xl w-full justify-center">
            ...
            <div className="mt-4 space-y-2 text-gray-600">
              ...
              <div className="flex items-center gap-2"><TbCalendarClock /> 1.5 Months</div>
          ...
          <div className="bg-white relative left-243 -top-170 rounded-xl shadow-lg  p-4 mt-4 h-fit">
            ...
            <p className="text-gray-600 text-sm p-4 text-justify leading-6">
              To participate in the Brand Management,Participants should have an interest in branding, marketing strategies, and consumer behavior. Good communication skills and creativity are important for developing brand identity and messaging. Strategic thinking and basic understanding of market trends are beneficial. Prior marketing knowledge is helpful but not compulsory, making the course suitable for students, entrepreneurs, and professionals.
            </p>
          </div> 
...
<h3 className="font-semibold text-2xl">Charlotte </h3>
        <p className="text-xl text-gray-500">Brand Management</p>
        </div>
    ...
    <div className="w-full md:w-1/3 text-xl">
      ...
      <ul className="text-[#003372] space-y-1">
        <li><NavLink to="/charweb">• Web Development</NavLink></li>
      </ul>
    </div>
  </div>
</div> <br />
