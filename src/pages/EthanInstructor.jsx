    ...
    <>
      ...
      <div className="bg-[#e1e1e1] flex justify-between p-[50px]">
        <div className="leading-[1.8]">
          ...
          <p>
            I am a professional 3D modeling, Business Analytics, and instructor
          ...
          <table className="bg-white">
            <thead>
              <tr>
                <th className="px-4 ">5 Yrs</th>
                <th className="px-4">9</th>
                <th className="px-4">21</th>
              </tr>
            </thead>
            <tbody>
              <tr>
      ...
      {/* ABOUT */}
      <div className="bg-[#01295C] p-10 flex gap-25  text-white justify-between ">
        ...
        <div className="mt-2">
          ...
          <p className="p-4 mt-5 mb-20 text-justify">
            As a professional 3D modeling, Business Analytics, and instructor on our e-learning platform, I bring years of experience in creating user-friendly and visually appealing designs. My courses are designed to help you master design principles, tools, and techniques, empowering you to craft exceptional digital experiences. Join me to turn your creativity into impactful designs
          </p>
      ...
      <div className="bg-[#e1e1e1] text-center p-10 ">
        ...
        <div className="flex ml-[420px] gap-15 p-4">
          {[ 
            { img:Modeling, title: "3D Modeling and Animation | 3 Months", instructor: "Ethan ", pic: Ethan,link:"/ethan3d" },
            { img: Business, title: "Business Analytics  | 3     Months", instructor: "Ethan ", pic: Ethan, link:"/ethanbusiness" },
          ].map((course, i) => (
            <div
              key={i}
...
export default Ethaninstructor