    ...
    <>
      ...
      <div className="bg-[#e1e1e1] flex justify-between p-[50px]">
        <div className="leading-[1.8]">
          ...
          <p>
            I am a professional Project Manager and instructor
            dedicated to helping you in Public Speaking & Presentation Skills <br />
          ...
          <table className="bg-white">
            <thead>
              <tr>
                <th className="px-4 ">6 Yrs</th>
                <th className="px-4">10</th>
                <th className="px-4">20</th>
              </tr>
            </thead>
            <tbody>
              <tr>
      ...
      <div className="bg-[#01295C] p-10 flex gap-[180px] text-white justify-between ">
        ...
        <div className="mt-2">
          ...
          <p className="p-4 mt-5 mb-20 text-justify">
            As a  professional Project Manager and instructor dedicated to helping you in Public Speaking & Presentation Skills on our e-learning platform, I bring years of experience in creating user-friendly and visually appealing designs. My courses are designed to help you master design principles, tools, and techniques, empowering you to craft exceptional digital experiences. Join me to turn your creativity into impactful designs
          </p>
...
export default Jordaninstructor
