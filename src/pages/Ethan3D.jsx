        ...
        >
          <div className="grid md:grid-cols-2 gap-8 p-10 text-white">
            ...
            <div className="space-y-4 ">
              <h1 className="text-3xl font-semibold">3D Modeling and Animation Course</h1>

              <div className="flex items-center gap-2">
                <img src={Ethan} alt="" className="w-8 h-8 object-cover rounded-full" />
                <p>By Ethan </p>
              </div>

              <p className="text-lg">
                Hey I am Ethan. I am a Modeling and Animation professional 
            ...
            <div className="flex justify-center">
              <img src={Modeling} alt="" className="w-72 mb-20 ml-50 -mt-10" />
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 p-4">
          ...
          <div className="lg:col-span-2 space-y-4 ">
            ...
            <p className="text-gray-600 font-medium text-justify pl-10">
              The 3D Modeling and Animation program introduces a creative and technical approach to building three-dimensional assets for games, animation, architecture, and product visualization. You will learn the complete 3D workflow, from basic modeling and texturing to lighting, rendering, and animation fundamentals. The program focuses on industry-standard tools and practical projects that develop strong visual and technical skills. By the end of the course, you will have a portfolio of 3D models demonstrating your ability to create realistic and stylized assets for professional use.
            </p>
            ...
            <div className="bg-white rounded-xl shadow shadow-black">
              ...
              <details open className="group border-b ">
                ...
                <div className="px-6 pb-4 space-y-3">
                  {[
                    "Definition of 3D Modeling and Animation",
                    "Importance of 3D Modeling and Animation",
                    "Overview of 3D Modeling and Animation Process",
                  ].map((item, i) => (
              ...
              {/* COLLAPSED SECTIONS */}
              {[
                "Basics of 3D Design & Modeling",
                "3D Shapes and Geometry",
                "Texturing & Materials",
                "Lighting & Rendering",
                "Character & Product Modeling",
                "Animation Basics",
                "Game & Architecture Models",
              ].map((title, i) => (
                <div
                  key={i}
          ...
          <div className="bg-white shadow-lg relative -mt-25 rounded-xl p-4 h-fit">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-3">
                <button onClick={() => (isWish('modeling') ? removeFromWishlist('modeling') : addToWishlist({ id: 'modeling', title: '3D Modeling and Animation', price: 10000 }))}>
                  <FaHeart className={`${isWish('modeling') ? 'text-red-500' : 'text-gray-400'} text-lg`} />
                </button>
<RiShareForwardLine
            ...
            <div className="mt-4">
              <button onClick={() => addToCart({ id: 'modeling', title: '3D Modeling and Animation', price: 10000 })} className="flex items-center gap-2 bg-[#003372] text-white px-4 py-2 rounded-xl w-full justify-center">
          ...
          {/* REQUIREMENTS */}
          <div className="bg-white relative left-243 -top-170 rounded-xl shadow-lg  p-4 mt-8 h-fit">
            ...
            <p className="text-gray-600 text-sm p-4 text-justify leading-6">
              To participate in the 3D Modeling and Animation,Participants should have a strong interest in visual design, animation, architecture, or game development. Basic computer operation skills are required, along with patience and attention to detail. Creativity and imagination play an important role in creating 3D objects and environments. Basic drawing skills and spatial understanding are helpful but not mandatory. Access to a computer with good processing power and graphics capability is recommended for smooth learning.
            </p>
          </div> 

          <div className=" relative left-124 -top-70 p-4 border-t h-fit space-y-2">
  ...
  <div className="flex justify-between items-center gap-6">
    ...
    <div className="flex items-center gap-4 bg-white shadow rounded-xl p-4 w-full max-w-xl">
      ...
      <div className="space-y-1 flex gap-15 items-center">
        <div>
<h3 className="font-semibold text-2xl">Ethan </h3>
        <p className="text-xl text-gray-500">3D Modeling and Animation</p>
        </div>
    ...
    <div className="w-full md:w-1/3 text-xl">
      ...
      <ul className="text-[#003372] space-y-1">
        <li><NavLink to="/ethanbusiness">• Business Analytics</NavLink></li>
      </ul>
    </div>
  </div>
</div> <br />
