        ...
        >
          <div className="grid md:grid-cols-2 gap-8 p-10 text-white">
            ...
            <div className="space-y-4 ">
              <h1 className="text-3xl font-semibold">Business Analytics Course</h1>
              ...
              <p className="text-lg">
                Hey I am Ethan. I am a Business Analytics professional 
            ...
            <div className="flex justify-center">
              <img src={Business} alt="" className="w-72 mb-20 ml-50 -mt-10" />
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 p-4">
          ...
          <div className="lg:col-span-2 space-y-4 ">
            ...
            <p className="text-gray-600 font-medium text-justify pl-10">
              The Business Analytics program takes a data-driven approach to solving business problems and supports informed decision-making. You will learn how to collect, clean, analyze, and visualize data to uncover insights and trends. The course covers analytical techniques, reporting tools, and real business case studies. By the end of the program, you will be able to interpret data, create dashboards, and communicate actionable insights to stakeholders, preparing you for analyst roles in various industries.
            </p>
              ...
              <details open className="group border-b ">
                ...
                <div className="px-6 pb-4 space-y-3">
                  {[
                    ...
                    "Overview of Business Analytics Process",
                  ].map((item, i) => (
          ...
          <div className="bg-white shadow-lg relative -mt-25 rounded-xl p-4 h-fit">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-3">
                <button onClick={() => (isWish('business') ? removeFromWishlist('business') : addToWishlist({ id: 'business', title: 'Business Analytics', price: 10000 }))}>
                  <FaHeart className={`${isWish('business') ? 'text-red-500' : 'text-gray-400'} text-lg`} />
                </button>
<RiShareForwardLine
            ...
            <div className="mt-4">
              <button onClick={() => addToCart({ id: 'business', title: 'Business Analytics', price: 10000 })} className="flex items-center gap-2 bg-[#003372] text-white px-4 py-2 rounded-xl w-full justify-center">
          ...
          <div className="bg-white relative left-243 -top-170 rounded-xl shadow-lg  p-4 mt-4 h-fit">
            ...
            <p className="text-gray-600 text-sm p-4 text-justify leading-6">
              To participate in the Business Analytics,Participants should have basic numerical and logical thinking skills and an interest in understanding business problems through data. Familiarity with spreadsheets such as Microsoft Excel is helpful. The ability to interpret charts, graphs, and reports is important for decision-making. Good problem-solving skills and attention to detail are beneficial. Prior business or analytics experience is not required, making the course suitable for beginners.
            </p>
          </div> 
...
<h3 className="font-semibold text-2xl">Ethan </h3>
        <p className="text-xl text-gray-500">Business Analytics</p>
        </div>
    ...
    <div className="w-full md:w-1/3 text-xl">
      ...
      <ul className="text-[#003372] space-y-1">
        <li><NavLink to="/ethan3d">• 3D Modeling and Animation</NavLink></li>
      </ul>
    </div>
  </div>
</div> <br />
