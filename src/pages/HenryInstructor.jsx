    ...
    <>
      ...
      <div className="bg-[#e1e1e1] flex justify-between p-[50px]">
        <div className="leading-[1.8]">
          ...
          <p>
            I am a professional Data Science, MERN Stack, and instructor
      ...
      <div className="bg-[#01295C] p-10 flex gap-25 text-white justify-between ">
        ...
        <div className="mt-2">
          ...
          <p className="p-4 mt-5 mb-20 text-justify">
            As a professional Data Science, MERN Stack, and instructor on our e-learning platform, I bring years of experience in creating user-friendly and visually appealing designs. My courses are designed to help you master design principles, tools, and techniques, empowering you to craft exceptional digital experiences. Join me to turn your creativity into impactful designs
          </p>
...
export default Henryinstructor;